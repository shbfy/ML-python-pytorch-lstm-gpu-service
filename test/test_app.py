...
def test_example_message(client):
    ...
    assert result.json == {'message': 'This service verifies a model using the IMDB Test data set. '
...
def test_classification_request(client):
    ...
    result = client.simulate_post('/imdb', headers={"Content-Type": "text/plain"}, body="Great movie!")
